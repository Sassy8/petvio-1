...
class HammsterPage extends StatefulWidget {
  const HammsterPage({super.key});

  @override
  State<HammsterPage> createState() => _HammsterPageState();
}

class _HammsterPageState extends State<HammsterPage> {
  @override
        ...
        children: [
          const Positioned(
            ...
            child: SizedBox(
              ...
              child: Image(
                image: AssetImage('assets/images/R (2).jpg'),
                fit: BoxFit.cover,
              ),
            ),
          ),
